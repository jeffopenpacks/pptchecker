...
1. **Clone** this repository and open a terminal in **`ppt-auditor/`** (this app’s root).  
...
| **`docs/`** | Product/requirements (**`PRD.md`**), **`Brief.md`** |
| **`public/`** | Static assets served from the site root |
| **`scripts/`**, **`assets/`**, **`data/`** | Optional placeholders |

This folder is self-contained: **`package.json`**, **`tsconfig.json`**, **`next.config.ts`**, etc. live here. Repo-wide agent notes: **`../docs/AGENTS.md`**.
